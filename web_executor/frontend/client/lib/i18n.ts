    ...
    guide: {
      ...
      assetFinder: {
        ...
        tips: [
          ...
          'Apply filters for price range, volume, market cap, and performance',
          'Sort results by clicking column headers',
          'Click refresh to get the latest stock data',
        ],
      },
      ...
      metallicaChatbot: {
        ...
        setupSteps: [
          ...
          'Enter the key in the chatbot interface',
          'Click "Validate" to activate the chatbot',
        ],
        googleAIStudio: 'Google AI Studio',
        
        tipsForBestResults: 'Tips for Best Results:',
        tips: [
          'Ask specific questions about Vietnamese stocks, sectors, or companies',
          'Questions can be in English or Vietnamese',
          'The system searches 12,000+ indexed news articles for context',
          'Response time is typically under 2 seconds',
        ],
      },
      ...
      architectureOverview: {
        ...
        bronzeLayer: {
          ...
          details: ['VNStock API data', 'Google CSE news', 'Economic indicators'],
        },
        
        silverLayer: {
          title: 'Silver Layer',
          description: 'Cleaned & enriched',
          details: ['Data validation', 'Schema normalization', 'Quality checks'],
        },
        
        goldLayer: {
          title: 'Gold Layer',
          description: 'Query-optimized',
          details: ['Aggregated metrics', 'Business views', 'Performance indexes'],
        },
      ...
      developmentWorkflow: {
        ...
        tests: [
          ...
          'Ensure integration tests pass before PR',
      ...
      howToContribute: {
        ...
        guidelines: [
          ...
          'Run linters before committing (ESLint, Black)',
        ],
      },
  ...
  vi: {
    ...
    guide: {
      ...
      assetFinder: {
        ...
        tips: [
          'Sử dụng thanh tìm kiếm để lọc cổ phiếu theo ký hiệu hoặc tên',
          'Áp dụng các bộ lọc cho phạm vi giá, khối lượng, vốn hóa thị trường và hiệu suất',
          'Sắp xếp kết quả bằng cách nhấp vào tiêu đề cột',
          'Nhấp vào làm mới để nhận dữ liệu chứng khoán mới nhất',
        ],
      },
      ...
      metallicaChatbot: {
        ...
        setupSteps: [
          ...
          'Tạo khóa API Gemini miễn phí',
          'Nhập khóa trong giao diện chatbot',
          'Nhấp vào "Xác Thực" để kích hoạt chatbot',
        ],
        googleAIStudio: 'Google AI Studio',
        
        tipsForBestResults: 'Mẹo Cho Kết Quả Tốt Nhất:',
        tips: [
          'Đặt những câu hỏi cụ thể về cổ phiếu, ngành hoặc công ty Việt Nam',
          'Câu hỏi có thể bằng tiếng Anh hoặc tiếng Việt',
          'Hệ thống tìm kiếm hơn 12.000 bài báo tin tức được lập chỉ mục',
          'Thời gian phản ứng thường dưới 2 giây',
        ],
      },
      ...
      architectureOverview: {
        ...
        bronzeLayer: {
          ...
          details: ['Dữ liệu API VNStock', 'Tin tức Google CSE', 'Chỉ số kinh tế'],
        },
        
        silverLayer: {
          title: 'Lớp Silver',
          description: 'Dữ liệu đã làm sạch & làm phong phú',
          details: ['Xác thực dữ liệu', 'Chuẩn hóa lược đồ', 'Kiểm tra chất lượng'],
        },
        
        goldLayer: {
          title: 'Lớp Gold',
          description: 'Tối ưu hóa cho truy vấn',
          details: ['Chỉ số tổng hợp', 'Chế độ xem kinh doanh', 'Chỉ số hiệu suất'],
        },
      ...
      developmentWorkflow: {
        ...
        tests: [
          'Viết các bài kiểm tra đơn vị cho tất cả các tính năng mới',
          'Đảm bảo các bài kiểm tra tích hợp vượt qua trước PR',
          'Kiểm tra cục bộ với dữ liệu mẫu',
          'Xác minh các loại TypeScript (không có loại bất kỳ)',
        ],
      },
