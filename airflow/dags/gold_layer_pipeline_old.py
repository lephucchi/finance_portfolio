...
# 1. analytics/ - Market features (MA, RSI, volatility)
# 2. sentiment_analysis/ - News sentiment by date/source  
# 3. serving/ - Pre-aggregated BI cache
# 4. metadata/ - Pipeline lineage tracking
#
# Author: finance_portfolio
# Schedule: 8 AM weekdays after Silver layer
# =====================================================
